<template>
  <div>
    <div class="address flex j-c a-c" v-if="address={}">
    ...
    <div class="address  flex a-c" v-else>
      ...
      <div class="w100 pl10">
        <div class="flex a-c j-b mb10">
          <div class="text1">收货人{{address.name}}</div>
          <div class="text2">{{address.tel}}</div>
        </div>
        <div class="text3 f14 mb5">收货地址:{{address.address}}</div>
