        ...
        <div class="p10">
          ...
          <div class="flex">
            ...
            <div class="flex1 flex mtb10 fromxx">
              <div class="mr10">
                <van-button color="rgb(230,5,127)" size="small" @click="dli" v-if="shopListAll.length">删除</van-button>
              </div>
              <div>
                <van-button color="rgb(230,5,127)" size="small" v-if="shopListAll.length">去结算</van-button>
              </div>
            </div>
          </div>
