        ...
        <div class="p10">
          <div class="flex" style="border-bottom:1px solid rgb(245,245,245) ;">
            <div class="flex1 flex a-c mb10">
              <input type="checkbox" class="text1 f18" v-model="checkAll" @click="select"/>
              <div class="ml5" v-if="flge===false">全选</div>
            </div>
            <div class="flex1 flex a-c mb10">
              <input type="checkbox" class="text1 f18" v-model="checkAll"/>
              <div class="ml5" v-if="flge===true">取消全选</div>
            </div>
