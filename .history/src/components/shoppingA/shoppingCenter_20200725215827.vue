<template>
  <div>
    <div class="wrapper" ref="wrapper" v-if="shopListAll.length">
      <div class="content">
        <div class="p10">
          <div class="flex" style="border-bottom:1px solid rgb(245,245,245) ;">
            <div class="flex1 flex a-c mb10" v-if="checkAll===false">
              <input type="checkbox" class="text1 f18" @change="Select" />
              <div class="ml5">全选</div>
            </div>
             <div class="flex1 flex a-c mb10" v-if="checkAll ===true" >
              <input type="checkbox" class="text1 f18"   @change="onSelect" />
              <div class="ml5">取消全选</div>
            </div>
