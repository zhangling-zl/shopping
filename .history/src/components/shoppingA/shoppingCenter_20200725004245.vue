  ...
  <div>
    ...
    <div v-else class="zanwu">
      <div class="yuan flex a-c j-c">
        <img src="../../assets/img/timg.jpg" alt class="img2" />
      </div>
      <div class="text f22 mt20">购物车竟然还是空的</div>
      <div class="f18 text2 mtb10">再忙,也要记得买点东西犒劳自己~~~</div>
      <div class="text1 f18 " @click="goShoppimg">去购物</div>
    </div>
  </div>
</template>
