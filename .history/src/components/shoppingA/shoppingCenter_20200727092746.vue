    ...
    <div class="wrapper" ref="wrapper">
      <ul class="content">
        <li class="p10" v-if="shopListAll.length">
          ...
          <div class="flex">
            <div class="flex1"></div>
            <div class="flex1 fromxx" :class="{visible:this.shopListAll.some((item)=>{return item.check===true})===true}">
              <div class="mr10">
            ...
            <div class="flex a-c ptb20" style="border-bottom:1px solid #eee ;">
              ...
              <div class="ml10">
                ...
                <div class="flex j-b a-c mt15" style="width: 230px;">
                  ...
                  <van-stepper v-model="item.count" @plus="addgood" />
                </div>
              </div>
            </div>
          </div>
