      ...
      <div class="wrapper" ref="wrapper">
        <div class="content">
          ...
          <div class="text2 flex j-b a-c">
            <div class="text2-1 f14 flex1">运费:{{goodsOne.__v}}</div>
            <div class="text2-2 f14 flex1">剩余:{{goodsOne.amount}}</div>
            <div class="flex a-c text2-3 f14 flex1" v-if="flge1===false" @click="Collection">
              <div class="mr5">收藏:</div>
              <van-icon name="like-o"/>
            </div>
            <div class="flex a-c j-e  text2-3 f14 flex1" v-if="flge1===true" @click="onCollection">
             <div> <div class="mr5">取消收藏:</div>
              <van-icon name="like" class="icon2"/></div>
            </div>
          </div>
