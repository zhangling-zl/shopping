<template>
  <div>
    <div class="box">
      ...
      <div class="text1 p15">
        <div class="text1-1 f18 mb5">{{goodsOne.name}}</div>
        <div class="text1-2">￥{{goodsOne.orl_price}}</div>
      </div>
      <div class="text2 p15 flex j-b a-c">
        <div class="text2-1">运费:{{goodsOne.__v}}</div>
        <div class="text2-2">剩余:{{goodsOne.amount}}</div>
        <div class="flex a-c text2-3">
          <div>收藏:</div>
