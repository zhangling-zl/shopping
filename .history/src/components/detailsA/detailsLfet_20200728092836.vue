      ...
      <div class="wrapper" ref="wrapper">
        <div class="content">
          ...
          <div class="text2 flex j-b a-c">
            ...
            <div class="text2-3" v-if="sun===1" @click="Collection">
              <div class="mr5 f14">收藏:</div>
              <van-icon name="like-o" />
            </div>
            <div class="flex a-c text2-3 f14" v-if="sun===0" @click="onCollection">
...
export default {
  ...
  methods: {
    ...
    //点击取消收藏
    onCollection() {
       this.$api.postCancel({id:this.goodsOne.id}).then(res=>{
         console.log(res);
       }).catch(err=>{
         console.log(err);
       })
