    ...
    <div class="box">
      ...
      <div class="wrapper" ref="wrapper">
        <div class="content">
          ...
          <div class="text1 p15">
            <div class="text1-1 mb5">{{goods.goodsOne.name}}</div>
            <div class="text1-2">￥{{goods.goodsOne.orl_price}}</div>
          </div>
          <div class="text2 flex j-b a-c">
            <div class="text2-1 f14">运费:{{goods.goodsOne.__v}}</div>
            <div class="text2-2 f14 j-c flex">剩余:{{goods.goodsOne.amount}}</div>
      ...
      >
        <div class="flex a-c fomm">
          <img :src="goods.goodsOne.image" class="P-img mr10" />
          <div>
            <div class="P-text1 f18 mb15">{{goods.goodsOne.name}}scgyhgx5t4reg46bnht64</div>
            <div class="P-text2 f600">￥{{goods.goodsOne.orl_price | toFixed}}</div>
          </div>
        </div>
        <div class="fomm flex">
          <div>
          ...
          <div class="flex a-c ml30">
            <div class="dv1" >-</div>
            <div class="dv3">{{goods.count}}</div>
            <div class="dv2">+</div>
          </div>
        </div>
        <div><van-button type="danger" class="button">立即购买</van-button></div>
      </van-popup>
    </div>
  </div>
</template>
