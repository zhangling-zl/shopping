  ...
  <div>
    <div class="box">
      ...
      <div class="wrapper" ref="wrapper">
        <div class="content">
          ...
          <div class="text2 flex j-b a-c">
            ...
            <div class="flex a-c text2-3 f14" v-if="flge1===true" @click="onCollection">
      ...
      <van-goods-action>
        ...
        <van-goods-action-icon icon="cart-o" text="购物车" :badge="sum" />
...
export default {
  ...
  methods: {
    ...
    Collection() {
      this.$api
        .postCollection(this.goodsOne) //传整个商品详情，商品详情是一个对象goodsOne
        .then((res) => {
          if (this.user) {
            Toast(res.msg);
            this.flge1 = true;
