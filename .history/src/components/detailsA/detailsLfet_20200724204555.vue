  ...
  <div>
    <div class="box">
      ...
      <van-goods-action>
        ...
        <van-goods-action-icon icon="cart-o" text="购物车" :badge="str"/>
        <van-goods-action-button type="warning" text="加入购物车" @click="shooping.length" />
...
export default {
  ...
  mounted() {
    ...
    this.shooping = JSON.parse(localStorage.getItem('shooping'))
  },
  watch: {},
  computed: {
    //  str(){
