  ...
  <div>
    <div class="boxs">
      <van-tabbar route>
        ...
        <van-tabbar-item replace to="/shopping" icon="shopping-cart-o" :badge="shopListAll.length">购物车</van-tabbar-item>
...
export default {
  ...
  methods: {},
  mounted() {
    let shopListAll = JSON.parse(localStorage.getItem('shopListAll'))
    console.log(shopListAll,'取出来的购物车数据');
