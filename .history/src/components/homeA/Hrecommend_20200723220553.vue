<template>
  <div>
    <van-grid :column-num="2" vue-router>
      <van-grid-item icon="paid" text="代付款" />
      <van-grid-item icon="description" :badge="strAll" text="评价" />
    </van-grid>
    <div class="bf">
              ...
              <div class="from p5">
                ...
                <div class="Button flex w100 mtb10">
                  <div class="car flex j-c a-c ptb5 flex1">
                    <van-icon name="cart" class="cf" @click="clicklogin()" />
                  </div>
...
export default {
  ...
  methods: {
    clicklogin() {
      this.$clicklogin();
      this.strAll++;
      // this.strAll = this.strAll.concat(this.str);
